...
build: ## Build our prod image.
	@docker build -t prod-laravel-base-image .

push: ## Push our prod image to ECR.
	@docker tag prod-laravel-base-image:latest 339712724064.dkr.ecr.eu-central-1.amazonaws.com/prod-laravel-base-image:latest
	@docker push 339712724064.dkr.ecr.eu-central-1.amazonaws.com/prod-laravel-base-image:latest
